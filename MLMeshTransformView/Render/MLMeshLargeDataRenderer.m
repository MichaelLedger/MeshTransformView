...
@implementation MLMeshLargeDataRenderer
{
...
- (void)loadMetal:(MTKView *)mtkView
{
    ...
    /*
     ...
     对于小于4KB（即4096字节）的一次性数据，使用setVertexBytes(_:length:index:)，如果数据长度超过4KB 或者需要多次使用顶点数据时，需要创建一个MTLBuffer对象
     */
...
//        [renderEncoder setVertexBuffer:dynamicDataBuffer offset:0 atIndex:0];
