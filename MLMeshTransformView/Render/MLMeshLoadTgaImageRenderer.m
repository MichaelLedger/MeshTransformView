...
@implementation MLMeshLoadTgaImageRenderer
{
...
{
    // 1.获取tag的路径
    NSURL *imageFileLocation = [[NSBundle mainBundle] URLForResource:@"TGAImg" withExtension:@"tga"];
    
    // 2.将tag文件转化为Image对象
    MLTGAImage *image = [[MLTGAImage alloc] initWithTGAFileAtLocation:imageFileLocation];
    if(!image)// 判断图片是否转换成功
    {
