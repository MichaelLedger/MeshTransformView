...
@interface MLMeshTransformView : UIView
...
@property (nonatomic, copy) MLMeshTransform *meshTransform;


// The contents of contentView will get rasterized as an image that will be used
// to texture the generated mesh. Don't add subviews to MLMeshTransformView directly,
...
@property (nonatomic) MLPoint3D lightDirection;
