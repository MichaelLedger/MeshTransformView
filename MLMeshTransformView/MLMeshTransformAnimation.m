...
@interface MLMeshTransformAnimation()
...
@property (nonatomic, copy) MLMeshTransform *startTransform;
@property (nonatomic, copy) MLMeshTransform *endTransform;
...
@implementation MLMeshTransformAnimation
...
- (MLMeshTransform *)currentMeshTransform
{
    if (!self.areTransformsCompatible) {
