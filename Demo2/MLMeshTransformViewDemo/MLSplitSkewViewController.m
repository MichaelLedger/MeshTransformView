...
@interface MLSplitSkewViewController ()

@property (nonatomic, strong) UIImageView *imageView;

@end

@implementation MLSplitSkewViewController
...
//                                   CGRectGetMidY(self.transformView.contentView.bounds));
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        self.transformView.meshTransform = [MLMutableMeshTransform doublePanelSeperated];
    });
...
//    self.transformView.meshTransform = [MLMutableMeshTransform doublePanel];
}
...
//    self.transformView.meshTransform = [MLMutableMeshTransform buldgeMeshTransformAtPoint:point withRadius:120.0 boundsSize:self.transformView.bounds.size];
    self.transformView.meshTransform = [MLMutableMeshTransform splitSkewTransromAtPoint:point boundsSize:self.transformView.bounds.size];
