...
typedef struct
{
    ...
    float2 texCoord;
    half3  color;
} APPLMeshTempleShaderInOut;

vertex APPLMeshTempleShaderInOut
templeTransformAndLightingShader2(APPLMeshVertex in [[stage_in]],
...
fragment float4 templeSamplingFragmentShader2(APPLMeshTempleShaderInOut in [[stage_in]],
                                             constant AAPLFrameData & frameData [[ buffer(AAPLBufferIndexUniforms) ]],
...
reflectionQuadTransformShader2(const device AAPLQuadVertex * vertices [[buffer(AAPLBufferIndexMeshPositions)]],
...
fragment float4
reflectionQuadFragmentShader2(QuadShaderInOut in [[stage_in]],
                             constant AAPLFrameData & frameData [[ buffer(AAPLBufferIndexUniforms) ]],
