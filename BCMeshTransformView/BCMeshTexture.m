...
- (void)renderView:(UIView *)view
{
    ...
    // View (0x7febb4e04840, BCMeshContentView) drawing with afterScreenUpdates:YES inside CoreAnimation commit is not supported.
    [view drawViewHierarchyInRect:view.layer.bounds afterScreenUpdates:NO];
    
    // Drawing a view (0x7fc663c287e0, BCMeshContentView) that has not been rendered at least once requires afterScreenUpdates:YES.
//    [view drawViewHierarchyInRect:view.layer.bounds afterScreenUpdates:YES];
    
    // iew (0x7febb4e04840, BCMeshContentView) drawing with afterScreenUpdates:YES inside CoreAnimation commit is not supported.
